...
export default {
    ...
    methods: {
        generateReport () { 
            ...
            let comprobantes_titulos = ['ORIGINAL', 'DUPLICADO']
            let page_number = 1
        ...
        emitir_encabezado( doc, titulo ) {
            ...
            doc.setFontSize(21);
            doc.setFont(this.fontFamily, "bold")
            doc.text(20, 25, this.comprobante.attributes.nombre_empresa.toUpperCase())
