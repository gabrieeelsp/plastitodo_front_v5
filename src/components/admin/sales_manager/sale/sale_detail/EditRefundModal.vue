...
export default {
    ...
    methods: {
        accept() {
            ...
            if( this.valid ){
                this.$emit('updateRefund', {
                    id: this.refund.id,
                    paymentmethod_id: this.refund.relationships.paymentmethod.id,
        ...
        onload() {
            this.max_value = Number(this.saldoTotalSale) * (-1) + Number(this.refund.attributes.valor)
            this.valor = this.refund.attributes.valor
            this.select = this.refund.relationships.paymentmethod.id
