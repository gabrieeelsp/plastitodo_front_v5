        ...
        <v-form @submit.prevent="submit" ref="form" v-model="valid"     >
            ...
            <v-row>
                ...
                <v-col cols="12" sm="4"  class=" pt-0 pb-0">
                    <v-text-field 
                        dense
                        v-model="item_cache_new.telefono_movil"
            ...
            <v-row>
                ...
                <v-col cols="12" sm="4"  class=" pt-0 pb-0">
                    <v-text-field 
                        dense
                        v-model="item_cache_new.punto_venta_fe"
...
export default {
    ...
    computed: {
        ...mapGetters({
            item_cache_new: 'sucursals_manager/item_cache_new',
        })
    },
    data () {
        return {
    ...
    methods: {
        ...mapActions({            
            store_item_new: 'sucursals_manager/store_item_new',
            set_reload_items: 'sucursals_manager/set_reload_items',
            add_item: 'sucursals_manager/add_item',
