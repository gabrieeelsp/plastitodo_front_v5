...
<script>
import SelectProductModal from '@/components/admin/stockmovements/stockmovement/selectProductModal.vue'
import selectProductCantidadModal from '@/components/admin/stockmovements/stockmovement/selectProductCantidadModal.vue'
...
export default {
    ...
    methods: {
        ...mapActions({
            add_subitem: 'stockmovements_manager/add_subitem',
        }),
