...
export default {
    ...
    methods: {
        ...mapActions({
            update_item_password: 'users_manager/update_item_password',
        }),
        validate () {
        ...
        async submit () {
            ...
            if ( this.valid ) {
                this.is_saving = true
                await this.update_item_password({password: this.password, password_confirmation: this.password_confirmation})
                    .then(() => {
