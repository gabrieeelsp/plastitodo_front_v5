    ...
    <div>
        <v-row class="">
            ...
            <v-col cols="12" sm="2" class="d-flex align-center">
                <v-select
                    dense
                    :items="[{name: 'Solo Empleados', value: true}, {name: 'Solo Clientes', value: false}]"
                    item-text="name"
                    item-value="value"
                    v-model="filters.is_empleados"
            ...
            <v-col>
                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                        <td>{{ item.id }}</td>
                        <td >{{ item.attributes.name }} {{ item.attributes.surname }}</td>
