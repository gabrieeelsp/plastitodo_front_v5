                    ...
                    <tbody>
                        ...
                        >   
                            ...
                            <template v-if="item.tipo == 'saleproduct'">
                                <template v-if="orderActive.client != null && orderActive.client.tipo == 'MAYORISTA'">
                            ...
                            <template v-if="item.tipo == 'combo'">
                                ...
                                <td v-if="orderActive.client != null && orderActive.client.tipo == 'MAYORISTA'" class="text-right" >{{ globalHelperFixeDecimalMoney(item.precio_may) }}</td>
