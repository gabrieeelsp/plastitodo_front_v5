...
<script>
import SelectProductModal from '@/components/admin/presupuestos/presupuesto_register/selectProductModal.vue'
import selectProductCantidadModal from '@/components/admin/presupuestos/presupuesto_register/selectProductCantidadModal.vue'
import selectProductCantidadCompletoModal from '@/components/admin/presupuestos/presupuesto_register/selectProductCantidadCompletoModal'
...
export default {
    ...
    methods: {
        ...mapActions({
            add_item: 'presupuestos_manager/add_item',
            add_combo_item: 'presupuestos_manager/add_combo_item',
        }),
        ...
        presupuesto_has_saleproduct ( saleproduct_id  ) {
        ...
        addItem (item) {
            ...
            this.itemSelected = null
            this.barcode = ''
            if ( !this.presupuesto_has_saleproduct(item.saleProductId) ) {
                this.add_item(item)
            }else {
        ...
        presupuesto_has_combo ( combo_id  ) {
        ...
        addComboItem (item) {
            this.selectProductCantidadModalVisible = false
            this.itemSelected = null
            if ( !this.presupuesto_has_combo(item.comboId) ) {
