            ...
            <v-col>
                ...
                >
                    ...
                    <tbody>
                        ...
                        <td >{{ purchaseproduct.relationships.supplier.attributes.name }}</td>
...
import PurchaseproductNew from '@/components/admin/stockproducts/stockproduct/PurchaseproductNew3'
