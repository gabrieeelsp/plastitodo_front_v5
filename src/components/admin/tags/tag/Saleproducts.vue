        ...
        <v-row>
            <v-col>
                ...
                >
                    ...
                    <tbody>
                        <tr
                        v-for="saleproduct in items_visibles"
                        :key="saleproduct.id"
                        >
                        ...
                        <td class="text-right" v-if="saleproduct.attributes.is_enable_web"><v-chip x-small class="ma-2" color="success" >Enable</v-chip></td>
                        <td class="text-right" v-else><v-chip x-small class="ma-2" color="warning" >Disable</v-chip></td>
...
export default {
    ...
    computed: {
        ...
        items_search: function () {
            return this.item.relationships.saleproducts.filter((i) => {
