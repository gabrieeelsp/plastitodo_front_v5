...
export default {
    ...
    actions: {
        item_new ({rootState}, payload) {
            return axios.post('/stocktransfers/new', {
        ...
        save_item( {getters}, is_confirmar ) {
            ...
            return axios.put(`stocktransfers/${getters.item.id}`, {
                data: {
                    id: getters.item.id,
                    type: 'stocktransfers',
                    attributes: null,
                    relationships: {
                        stocktransferitems: json_items,
                    },
                    meta: {
        ...
        set_items({ commit, getters }, payload) {
            ...
            if ( getters.item ) {
                getters.items.filter((i) => {
                    ...
                    return false
                })[0].relationships.stocktransferitems = getters.item.relationships.stocktransferitems
            }
        },
