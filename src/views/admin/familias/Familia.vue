...
import Resumen from '@/components/admin/familias/familia/Resumen'
import Images from '@/components/admin/familias/familia/Images'
...
export default {
    ...
    computed: {
        ...mapGetters({
            item: 'familias_manager/item'
        })
    },
    methods: {
        ...mapActions({
            buscar_item: 'familias_manager/buscar_item',
