            ...
            <v-col cols="12" md="12">
                <v-card class="">
                    <v-card-title class="d-flex justify-space-between align-center pt-1 pb-1">                
                        <span class="text-h4 font-weight-light">Gestión de Etiquetas</span>
...
export default {
    ...
    computed: {
        ...mapGetters({
            items: 'tags_manager/items',
            list_meta: 'tags_manager/list_meta',
            reload_items: 'tags_manager/reload_items',
        })
    },
    methods: {
        ...mapActions({
            buscar_items: 'tags_manager/buscar_items',
            set_items: 'tags_manager/set_items',
